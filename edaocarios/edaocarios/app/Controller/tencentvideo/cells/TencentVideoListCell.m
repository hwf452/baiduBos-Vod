...
@implementation TencentVideoListCell
...
-(void)loadContent:(NSObject *)cellModel index:(NSInteger)index1{
    ...
    _lb_fileId.text=[dict objectForKey:@"fileId"];
    _lb_fileName.text=[dict objectForKey:@"fileName"];
    [_carLogoImageView sd_setImageWithURL:[NSURL URLWithString:[dict objectForKey:@"imageUrl"]]];
